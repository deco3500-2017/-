...
<h4>Integration</h4>
It was decided that due to the challenges posed such as privacy and storage space, and the simplicity to subvert this security measure, there was a decision made to not include this feature in the high fidelity prototype. See <a href="#changes-on-the-rate-my-helper-interface">initial inclusion on the mockups</a>.
